...
public class Human {
    ...
    // a non-static property is always dependent on some instance of an object, whereas static property doesn't depend on object // -> inside which it is defined
    // -> since non-static are associated to instance they are stored in heap
    ...
    /*
    NOTE: population variable keeps track of number of human objects
