...
public abstract class Parent {
    ...
    // -> NO, since final doesn't allow extension of class, whereas abstract tells us to extend and override method,
    //  both contradict
    abstract void run();

    // abstract static void build();
    // -> abstract and static is not possible because they contradict each other,
    //  what I mean is
    ...
    void greeting() {
        System.out.println("Hello World! This is abstract parent.");
    }
    public int getX() {
        return x;
    }
