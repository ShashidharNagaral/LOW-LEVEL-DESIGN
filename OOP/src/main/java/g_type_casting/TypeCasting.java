...
//        int num = input.next(); //    this won't work bcz string are not compatible to int, float
        ...
        // 2. Narrowing Type Casting (explicit type casting) : this happens in Higher data type to Lower data type
        b = 12.343;
        // a = b;    // this will show error
        a = (int) b; // this is called explicitly type casting => 12
        System.out.println(a);
        // NOTE: since, we are converting from higher to lower data type there is the loss of data
