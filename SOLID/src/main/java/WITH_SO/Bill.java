...
public class Bill {
    ...
    /*
        NOTE:
        - In the `WITH_S` package, `BillPrinter` and `BillingSystem` are treated as separate concrete classes.
        ...
        - This approach adds new functionality to the `BillingSystem` class by allowing it to delegate printing responsibilities
